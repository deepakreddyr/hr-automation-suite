...
const StatsCard = ({ title, value, description, icon }: StatsCardProps) => (
  <Card>
    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      ...
      <div className="h-8 w-8 rounded-full bg-hr-100 p-1 text-hr-600 flex items-center justify-center">
        {icon}
      </div>
    </CardHeader>
    <CardContent>
  ...
  return (
    <div className="grid gap-4 md:grid-cols-3">
      <StatsCard
        ...
        value={stats.candidates_processed}
      ...
      <StatsCard
        ...
        description="Qualified for next round"
        icon={
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4">
      ...
      <StatsCard
        ...
        value={stats.calls_scheduled}
        description="Automated calls to candidates"
        icon={
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4">
